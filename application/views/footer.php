            ...
            <div class="nicdark_margin10">
                ...
                <?php
                                ...
                                foreach($eventgallery as $gallery){
                                    ...
                                    $img = json_decode($gallery->images);
                                    
                                    //print_r($img); exit;
                                    $img_src = str_replace('../',base_url(),$img[0]->name); 
                ...
                <div class="nicdark_margin10">
                    <a href"'.base_url('gallery/'.$gallery->id.'/'.$gallery->eventname).'"> <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus" src="'.$img_src.'"></a>
                </div>
            </div>
                                                   ';
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="https://www.facebook.com/soroticricketacademy/" target="_blank" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
...
<!-- Mirrored from www.nicdarkthemes.com/themes/baby-kids/html/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Jan 2020 22:00:40 GMT -->
</html>